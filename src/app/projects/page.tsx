...
const allProjects = [
    ...
    liveUrl: 'https://creativearts4u.netlify.app/',
    repoUrl: 'https://github.com/RaizanShirshikar/CreativeArts.git',
  },
  {
    id: 'project-2',
    title: 'E-State Dashboard',
    description: 'A real-time dashboard for monitoring real estate market trends, featuring interactive data visualizations and user analytics.',
    imageId: '2',
    tech: ['React', 'Firebase', 'Tailwind CSS'],
    liveUrl: 'https://p2-estate.netlify.app/',
    repoUrl: '#',
  },
  {
    id: 'project-3',
    title: 'E-State Website',
    description: 'A mobile app for real estate listings with advanced search filters, interactive maps, and user reviews.',
    imageId: '3',
    tech: ['React Native', 'Figma', 'Node.js'],
    liveUrl: 'real-state-p1.netlify.app',
    repoUrl: '#',
  },
    // {
    //     id: 'project-4',
    ...
    //     liveUrl: 'dimound-consulting.netlify.app',
    //     repoUrl: '#',
    // },
    // {
    //     id: 'project-5',
